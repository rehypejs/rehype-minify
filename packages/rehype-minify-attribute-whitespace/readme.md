...
*   [Use](#use)
*   [API](#api)
    *   [`unified().use(rehypeMinifyAttributeWhitespace)`](#unifieduserehypeminifyattributewhitespace)
*   [Example](#example)
*   [Syntax](#syntax)
...
```js
import rehypeMinifyAttributeWhitespace from 'https://cdn.skypack.dev/rehype-minify-attribute-whitespace@3?dts'
```
...
```html
<script type="module">
  import rehypeMinifyAttributeWhitespace from 'https://cdn.skypack.dev/rehype-minify-attribute-whitespace@3?min'
</script>
```
...
```sh
rehype input.html --use rehype-minify-attribute-whitespace --output output.html
```
...
The default export is `rehypeMinifyAttributeWhitespace`.
