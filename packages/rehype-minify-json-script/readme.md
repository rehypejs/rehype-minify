...
*   [Use](#use)
*   [API](#api)
    *   [`unified().use(rehypeMinifyJsonScript)`](#unifieduserehypeminifyjsonscript)
*   [Example](#example)
*   [Syntax](#syntax)
...
```js
import rehypeMinifyJsonScript from 'https://cdn.skypack.dev/rehype-minify-json-script@3?dts'
```
...
```html
<script type="module">
  import rehypeMinifyJsonScript from 'https://cdn.skypack.dev/rehype-minify-json-script@3?min'
</script>
```
