...
test('hast-util-is-javascript', function (t) {
  ...
  t.ok(ok(h('script', {type: 'text/ecmascript'})), 'yes - for `text/ecmascript` type');
  t.ok(ok(h('script', {language: 'ecmascript'})), 'yes - for `ecmascript` language');
  t.ok(ok(h('script', {type: 'text/jscript'})), 'yes - for `text/jscript` type');
  t.ok(ok(h('script', {language: 'jscript'})), 'yes - for `jscript` language');
  t.ok(ok(h('script', {type: 'text/javascript1.5'})), 'yes - for `text/javascript1.5` type');
  t.ok(ok(h('script', {language: 'javascript1.5'})), 'yes - for `javascript1.5` language');
  ...
  t.ok(ok(h('script', {type: 'text/javascript', language: 'fooscript'})), 'yes - for JS type with other language');
