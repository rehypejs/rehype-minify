...
```js
import rehypeMinifyStyleAttribute from 'https://cdn.skypack.dev/rehype-minify-style-attribute@3?dts'
```
...
```html
<script type="module">
  import rehypeMinifyStyleAttribute from 'https://cdn.skypack.dev/rehype-minify-style-attribute@3?min'
</script>
```
