...
*   [Use](#use)
*   [API](#api)
    *   [`unified().use(rehypeMinifyJavaScriptUrl)`](#unifieduserehypeminifyjavascripturl)
*   [Example](#example)
*   [Syntax](#syntax)
...
`rehype-minify-javascript-url@^4`,
...
[size]: https://bundlejs.com/?q=rehype-minify-javascript-url

[size-badge]: https://img.shields.io/bundlejs/size/rehype-minify-javascript-url
