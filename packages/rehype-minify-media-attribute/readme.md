...
```js
import rehypeMinifyMediaAttribute from 'https://cdn.skypack.dev/rehype-minify-media-attribute@3?dts'
```
...
```html
<script type="module">
  import rehypeMinifyMediaAttribute from 'https://cdn.skypack.dev/rehype-minify-media-attribute@3?min'
</script>
```
