...
*   [Use](#use)
*   [API](#api)
    *   [`unified().use(rehypeMinifyMetaColor)`](#unifieduserehypeminifymetacolor)
*   [Example](#example)
*   [Syntax](#syntax)
...
```js
import rehypeMinifyMetaColor from 'https://cdn.skypack.dev/rehype-minify-meta-color@3?dts'
```
...
```html
<script type="module">
  import rehypeMinifyMetaColor from 'https://cdn.skypack.dev/rehype-minify-meta-color@3?min'
</script>
```
...
The default export is `rehypeMinifyMetaColor`.
